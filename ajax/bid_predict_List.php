...
try {
  $sql = "CALL bid_predict_List(:fdate, :tdate, :bidNtceNo, :bidNtceNm, :psize, :cpage)";
  $sql_log = "CALL bid_predict_List('$fdate', '$tdate', '$bidNtceNo', '$bidNtceNm', $psize, $cpage)";
  ...
  // 페이지 처리
  $sql = "CALL bid_predict_ListCount(:fdate, :tdate, :bidNtceNo, :bidNtceNm, :psize)";
  $sql_log = "CALL bid_predict_ListCount('$fdate', '$tdate', '$bidNtceNo', '$bidNtceNm', $psize)";
  error_log($sql_log."\n", 3, "../log/log-".date("Ymd").".log");
