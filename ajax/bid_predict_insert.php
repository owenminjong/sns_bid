...
try {
  ...
  $sql = "CALL bid_predict_insert(:bsn, :bidNtceNo, :bidNtceNm, :bssamt, :Aamt, :realAmt, :urate, :preamt, :sfcode)";
  $sql_log = "CALL bid_predict_insert($bsn, '$bidNtceNo', '$bidNtceNm', $bssamt, $Aamt, $realAmt, '$urate', $preamt, $sfcode)";
