...
$famt = $_REQUEST["famt"] ? $_REQUEST["famt"] : 0;
$tamt = $_REQUEST["tamt"] ? $_REQUEST["tamt"] : 0;
$psize = $_REQUEST["psize"];
$cpage = $_REQUEST["cpage"];

try {
  $sql = "CALL api_bid_List2(:fdate, :tdate, :bidNtceNo, :bidNtceNm, :isopen, :famt, :tamt, :psize, :cpage)";
  $sql_log = "CALL api_bid_List2('$fdate', '$tdate', '$bidNtceNo', '$bidNtceNm', $isopen, $famt, $tamt, $psize, $cpage)";
  ...
  $stmt->bindValue(":isopen", $isopen);
  $stmt->bindValue(":famt", $famt);
  $stmt->bindValue(":tamt", $tamt);
  ...
  // 페이지 처리
  $sql = "CALL api_bid_ListCount2(:fdate, :tdate, :bidNtceNo, :bidNtceNm, :isopen, :famt, :tamt, :psize)";
  $sql_log = "CALL api_bid_ListCount2('$fdate', '$tdate', '$bidNtceNo', '$bidNtceNm', $isopen, $famt, $tamt, $psize)";
  error_log($sql_log."\n", 3, "../log/log-".date("Ymd").".log");
