...
try {
  ...
  if ( empty($sfcode) )throw new Exception("잘못된 자료이거나 없는 자료입니다.");
  ...
  $sql = "CALL Staff_Update(:sfcode, :sfname, :tel, :sfid, :sfpw, :issvr, :isuse)";
  $sql_log = "CALL Staff_Update($sfcode, '$sfname', '$tel', '$sfid', '$sfpw', $issvr, $isuse)";
